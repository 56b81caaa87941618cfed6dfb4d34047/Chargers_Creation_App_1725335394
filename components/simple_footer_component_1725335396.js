...
<template>
    <footer id="footer-section" style="min-height: 390px" class="flex-1 bg-gradient-to-r from-pink-500 to-purple-600 bg-opacity-70 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg p-8" ><div id="footer-container" class="max-w-screen-xl mx-auto" style=""><hr id="footer-divider" class="my-6 border-pink-300 opacity-30 sm:mx-auto lg:my-8"> <div id="footer-content" class="text-center"><div class="flex"><a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-white hover:text-pink-200 transition duration-300" style="" data-mf-new="true"><img id="footer-logo" src="https://makeinfinite-mentat-dev.azurewebsites.net/get_image/Chargers_Creation_App_1725335394/logo.svg" alt="Landwind Logo" class="h-8 mr-3 sm:h-10 filter brightness-0 invert">
